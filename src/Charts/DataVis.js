		...
		docRef.get()
			.then(doc => {
				if (!doc.exists) {
					...
					let list = [userData.jobs_accepted, userData.jobs_denied, userData.jobs_pending];
					this.setState({ data: list, jobs_applied: userData.jobs_applied, loading: false });
				}
			});
